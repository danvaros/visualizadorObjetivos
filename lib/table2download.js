    ...
    $.fn.table_download = function( options ) {
        ...
        if (settings.format == "xls") {
            return this.each(function() {
                ...
                // Nueva hoja en llibro XLS

                csv += '<Worksheet ss:Name="Sheet2">'+settings.newline;
                csv += '<Table>'+settings.newline;
                // loop each row of the table
                $(this).find("tr").each(function () {
                    csv += '<Row>'+settings.newline;
                ...
                //
                //
                // $(".table_download_xls_link").on('click', function() {
                //   location.href = this.href; // ir al link
                // });
                //
                // $(".table_download_xls_link").click();
                ...
                var download_link = $('.table_download_xls_link');

                $(".table_download_xls_link").on('click', function() {
                  location.href = this.href; // ir al link
                  //this.setAttribute('download','descarga.xls');  = this.download;
                });
