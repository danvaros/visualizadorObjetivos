...
function listadoTablas(PCveInd){
  ...
  $.ajax({
    type: 'POST',
    url: "https://ods.org.mx/v2/API/Valores/PorClave",
  ...
  $.ajax({
    type: 'POST',
    url: "https://ods.org.mx/v2/API/AtrIndicador/PorDesglose",
  ...
  $.ajax({
    ...
    url: "https://ods.org.mx/v2/API/Tematica/PorClave",
...
if(PCveInd == 118){
  $.ajax({
    type: 'POST',
    url: "https://ods.org.mx/v2/API/Valores/PorCobCla",
